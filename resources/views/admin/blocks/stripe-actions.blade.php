<div class="box-payment-btn">
  ...
  <div class="row">
    <div class="col-imput">
      <label>Email:</label>
      <input id="u_email" type="text" class="form-control" value="<?php echo $customer->email ?>"/>
    </div>
    ...
    <div class="col-imput">
      ...
      <input id="u_phone" type="text" class="form-control" value="<?php echo $customer->phone ?>"/>
    </div>
    <div class="stripeAction">
