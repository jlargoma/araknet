	...
	<div class="form-row" style="padding: 20px 15px; background-color: #93e1ff">
  	...
  	<div class="row">
	  	<div class="col-md-6 col-xs-6" style="margin-top: 20px; ">
			<button class="button button-3d button-medium button-rounded button-green" type="submit">Acepto</button>
		</div>	
		<div class="col-md-6 col-xs-6" style="margin-top: 20px; ">
			<a href="{{ url()->previous() }}" class="button button-3d button-medium button-rounded button-red">
				No acepto
			</a>
		</div>
  	</div>
