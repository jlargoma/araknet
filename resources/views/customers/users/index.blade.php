...
@section('title') Mi cuenta- Araknet @endsection
...
<div class="row">
	<div class="col-md-12 col-xs-12">
		...
		<div class="col-md-3 col-xs-12">
			@if( $customer->contractAccepted == 1)<a href="{{ url('/clientes/mi-servicios')}} ">@endif
				<div class="col-xs-12 text-center">
			...
			@if( $customer->contractAccepted == 1)</a>@endif
		</div>
		<div class="col-md-3 col-xs-12">
			@if( $customer->contractAccepted == 1)<a href="{{ url('/clientes/mi-cuenta')}} ">@endif
				<div class="col-xs-12 text-center">
